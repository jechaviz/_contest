...
Submission video limit: under 3 minutes.

Tone: operational, evidence-first, no marketing fluff.

## Deck

1. Title: ContestOps AI, AI-native operations for founders chasing high-value
   opportunities.
2. Problem: opportunity-to-submission work is slow, brittle, and evidence-heavy.
3. Customer: founders, SMB service firms, grant teams, hackathon builders, and
   professional service operators.
4. Product: ingest rules, plan work, build evidence, run external submissions,
...
0:35-1:05: Show Gemini-generated plan and checklist mapped to contest rules.
...
2:35-2:55: Show Google Cloud/Gemini usage receipts and repo/testing path.

2:55-3:00: Close on category impact: faster founder launches and job creation.
...
Use English captions and avoid copyrighted music or protected third-party marks.
